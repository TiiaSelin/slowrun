        ...
        data = [
            {
                ...
                "\n\nSlowrun aikoo kannustaa täysillä tätä peliurakkaa. Jos lähiaikoina koet satunnaista hyvän olon tunnetta, lähes ekstaasiin verrattavaa tunnetta, ei ole syytä huoleen. Tämän on tarkoitus tapahtua. Ja nyt tiedät, mistä se johtuu."
                ),
                "date": timezone.now(),
            ...
            },
            {
                ...
                "Tilassa on yhdistettynä kaksi elinehtoa: pelaaminen ja sauna! \n\nTule pelaamaan ja saunomaan! "
